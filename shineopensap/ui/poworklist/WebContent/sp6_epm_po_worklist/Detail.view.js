sap.ui.jsview("sp6_epm_po_worklist.Detail", {

	getControllerName : function() {
		return "sp6_epm_po_worklist.Detail";
	},
...
function buildItemsTab(oController,oTabStrip){
    ...
    //Product Name
    oControl = new sap.ui.commons.TextField().bindProperty("value","ProductName");
    oTable.addColumn(new sap.ui.table.Column({label:new sap.ui.commons.Label({text: oBundle.getText("product_name")}), template: oControl, sortProperty: "ProductName", filterProperty: "ProductName", width: "150px" }));
    oTable.setModel(oModelItem);
